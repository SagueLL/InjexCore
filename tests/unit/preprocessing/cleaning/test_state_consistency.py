"""Unit tests for ``src.preprocessing.cleaning.state_consistency``."""
...
import pandas as pd
from src.preprocessing.cleaning import state_consistency
from src.preprocessing.cleaning.column_groups import ColumnGroups
from src.preprocessing.cleaning.policy import CleaningPolicy
