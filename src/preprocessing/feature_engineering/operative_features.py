...
live in :mod:`src.preprocessing.time_series.state_features`. This stage emits
...
from src.preprocessing.feature_engineering.column_groups import ColumnGroups
from src.preprocessing.feature_engineering.policy import FeatureEngineeringPolicy
from src.preprocessing.feature_engineering.reporting import Finding, Severity
...
def _time_since_last_active(flag: pd.Series) -> pd.Series:
    """Mirror of :func:`src.preprocessing.time_series.state_features._time_since_last_active`.
