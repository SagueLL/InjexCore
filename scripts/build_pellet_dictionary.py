...
DST = FEATURES_DIR / "data_pellets_dictionary.csv"
...
COLUMN_META: dict[int, tuple[str, str, str, str]] = {
    ...
    2: (
        "deposit_equipment_id",
        "categorical",
        "Source deposit / equipment identifier",
        "low",
    ),
    ...
    4: (
        "batch_quality_id",
        "categorical",
        "Quality batch identifier (Lote_id&2)",
        "low",
    ),
    5: (
        "feeder_max_speed_sp",
        "float",
        "Setpoint: feeder maximum speed in working phase",
        "medium",
    ),
    ...
    7: (
        "granulator_power_sp",
        "float",
        "Setpoint: granulator power in working phase",
        "medium",
    ),
    8: ("conditioner_temp_sp", "float", "Setpoint: conditioner temperature", "medium"),
    9: (
        "expander_cone_pressure_sp",
        "float",
        "Setpoint: expander cone pressure",
        "medium",
    ),
    10: (
        "conditioner_inlet_temp",
        "float",
        "Conditioner L-2 inlet product temperature (sensor 4)",
        "high",
    ),
    11: (
        "granulator_roller_gap",
        "float",
        "Granulator G2 roller separation distance",
        "medium",
    ),
    12: (
        "granulator_power",
        "float",
        "Granulator G2 motor power (motors A and B)",
        "high",
    ),
    13: (
        "steam_valve_temp_me2",
        "float",
        "Steam temperature at ME2 pressure-regulating valve to conditioner",
        "high",
    ),
    14: (
        "steam_valve_flow_me2",
        "float",
        "Steam mass flow through ME2 dosing valve to conditioner",
        "high",
    ),
    15: (
        "steam_valve_pressure_me2",
        "float",
        "Steam pressure at ME2 pressure-regulating valve to conditioner",
        "high",
    ),
    16: (
        "granulator_production_rate",
        "float",
        "Granulator G2 instantaneous production rate",
        "high",
    ),
    17: (
        "granulator_g2_state_pct",
        "float",
        "Granulator G2 SCADA auxiliary state register",
        "medium",
    ),
    ...
    20: (
        ...
        "float",
        "Conditioner L-2 SCADA auxiliary state register",
        "medium",
    ),
    21: ("conditioner_me2_alarm", "bool", "Conditioner L-2 (ME2) alarm flag", "high"),
    22: (
        "conditioner_me2_direct",
        "bool",
        "Conditioner L-2 (ME2) direct-drive state flag",
        "medium",
    ),
    23: (
        "feeder_hopper_temp",
        "float",
        "Feeder hopper temperature, granulation line L-2 (0-150 C)",
        "high",
    ),
    ...
    25: (
        ...
        "float",
        "Conditioner L-2 steam control-loop temperature (sensor 1)",
        "high",
    ),
    ...
    27: (
        ...
        "float",
        "Expander EX2 hydraulic group cone pressure",
        "high",
    ),
    28: (
        "feeder_al2_state_pct",
        "float",
        "Feeder AL2 SCADA auxiliary state register",
        "medium",
    ),
    ...
    31: (
        ...
        "float",
        "Steam dosing valve ME2 opening percentage",
        "medium",
    ),
    32: (
        "expander_ex2_outlet_temp",
        "float",
        "Expander EX2 outlet product temperature (sensor 1)",
        "high",
    ),
    33: (
        "extruder_specific_energy",
        "float",
        "Extruder specific energy consumption (Kwh per tonne)",
        "high",
    ),
    34: (
        "inlet_hopper_humidity",
        "float",
        "Inlet hopper material humidity (NEW)",
        "high",
    ),
    35: (
        "inlet_hopper_points",
        "float",
        "Inlet hopper sensor reading in 'points' (NEW, unitless raw count)",
        "medium",
    ),
    36: (
        "inlet_hopper_temp",
        "float",
        "Inlet hopper material temperature (NEW)",
        "high",
    ),
}
