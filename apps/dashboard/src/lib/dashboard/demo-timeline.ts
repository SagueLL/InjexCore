...
export const demoOperationalTimeline: OperationalTimeline = {
  ...
  series: [
    { date: "2024-06-14", deviationScore: 0.08, incidentCount: 0, status: "normal" },
    { date: "2024-06-24", deviationScore: 0.11, incidentCount: 0, status: "normal" },
    { date: "2024-07-04", deviationScore: 0.18, incidentCount: 1, status: "normal" },
    { date: "2024-07-15", deviationScore: 0.29, incidentCount: 2, status: "warning" },
    { date: "2024-07-26", deviationScore: 0.38, incidentCount: 3, status: "warning" },
    { date: "2024-08-05", deviationScore: 0.52, incidentCount: 4, status: "drift" },
    { date: "2024-08-15", deviationScore: 0.64, incidentCount: 5, status: "drift" },
    { date: "2024-08-26", deviationScore: 0.81, incidentCount: 6, status: "critical" },
    { date: "2024-09-03", deviationScore: 0.74, incidentCount: 5, status: "drift" },
  ],
  periods: [
    {
